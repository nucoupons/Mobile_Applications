...
import static org.jclouds.aliyun.ecs.predicates.SshKeyPairPredicates.nameMatches;
import static org.jclouds.aliyun.ecs.predicates.ZonePredicates.supportsSecurityGroups;
...
import org.jclouds.aliyun.ecs.compute.options.AliyunEcsTemplateOptions;
import org.jclouds.aliyun.ecs.domain.SecurityGroup;
import org.jclouds.aliyun.ecs.domain.SshKeyPair;
import org.jclouds.aliyun.ecs.domain.Zone;
import org.jclouds.aliyun.ecs.domain.ZoneAndName;
import org.jclouds.aliyun.ecs.predicates.SecurityGroupPredicates;
...
@Singleton
public class AliyunEcsComputeService extends BaseComputeService {
   protected final AliyunEcsApi client;
   ...
   @Inject
   protected AliyunEcsComputeService(ComputeServiceContext context, Map<String, Credentials> credentialStore,
            ...
            @Named(Constants.PROPERTY_USER_THREADS) ListeningExecutorService userExecutor, AliyunEcsApi client,
   ...
   /**
    * returns template options, as {@link AliyunEcsTemplateOptions}.
    */
   @Override
   public AliyunEcsTemplateOptions templateOptions() {
      return AliyunEcsTemplateOptions.class.cast(super.templateOptions());
   }
