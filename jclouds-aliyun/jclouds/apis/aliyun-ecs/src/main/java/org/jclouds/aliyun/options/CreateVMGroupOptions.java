...
public class CreateVMGroupOptions extends BaseHttpRequestOptions {
   ...
   public static class Builder {
      /**
       * @see org.jclouds.aliyun.options.CreateVMGroupOptions#account
       */
      ...
      /**
       * @see org.jclouds.aliyun.options.CreateVMGroupOptions#domainId
       */
      ...
      /**
       * @see org.jclouds.aliyun.options.CreateVMGroupOptions#projectId(String)
       */
