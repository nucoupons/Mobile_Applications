...
import org.jclouds.aliyun.ecs.domain.LoginResponse;
import org.jclouds.aliyun.ecs.features.SecurityGroupApi;
import org.jclouds.aliyun.ecs.features.SessionApi;
import org.jclouds.aliyun.ecs.features.ZoneApi;
import org.jclouds.aliyun.ecs.filters.AddSessionKeyAndJSessionIdToRequest;
import org.jclouds.aliyun.ecs.filters.AuthenticationFilter;
import org.jclouds.aliyun.ecs.filters.QuerySigner;
import org.jclouds.aliyun.ecs.handlers.AliyunEcsErrorHandler;
import org.jclouds.aliyun.ecs.handlers.InvalidateSessionAndRetryOn401AndLogoutOnClose;
import org.jclouds.aliyun.ecs.loaders.LoginWithPasswordCredentials;
...
/**
 * Configures the AliyunEcs connection.
 */
@ConfiguresHttpApi
public class AliyunEcsHttpApiModule extends HttpApiModule<AliyunEcsApi> {
	...
	protected void configure() {
		...
		bind(CredentialType.class).toProvider(
				CredentialTypeFromPropertyOrDefault.class);
		...
		bindHttpApi(binder(), SecurityGroupApi.class);
		bindHttpApi(binder(), ZoneApi.class);
	...
	static class CredentialTypeFromPropertyOrDefault implements
		 ...
		 * so that we don't have to set a default property.
		 */
		@Inject(optional = true)
		@Named(AliyunEcsProperties.CREDENTIAL_TYPE)
		String credentialType = CredentialType.API_ACCESS_KEY_CREDENTIALS
				.toString();
	 ...
	 * we want to filter the request. <br/>
	 * for ex, if we are getting passwords, we know we will need to
	 * login/logout. Otherwise we are signing requests.
	 */
	@Provides
	@Singleton
	protected AuthenticationFilter authenticationFilterForCredentialType(
		...
		default:
			throw new IllegalArgumentException(
					"credential type not supported: " + credentialType);
		}
	}
	...
	@Provides
	@Singleton
	protected Supplier<LoginResponse> provideLoginResponseSupplier(
			final LoadingCache<Credentials, LoginResponse> cache,
