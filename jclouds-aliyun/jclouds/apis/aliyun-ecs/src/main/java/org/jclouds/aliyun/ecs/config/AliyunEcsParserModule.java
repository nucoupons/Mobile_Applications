...
public class AliyunEcsParserModule extends AbstractModule {

   @Override
   protected void configure() {
      bind(DateAdapter.class).to(AliyunEcsDateAdapter.class);
    ...
    * 
    */
   public static class AliyunEcsDateAdapter extends Iso8601DateAdapter {

      @Inject
      private AliyunEcsDateAdapter(DateService dateService) {
         super(dateService);
      }
