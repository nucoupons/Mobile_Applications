...
public class AliyunSecurityGroupExtension implements SecurityGroupExtension {
   ...
   public Set<SecurityGroup> listSecurityGroups() {
      Iterable<? extends org.jclouds.aliyun.domain.SecurityGroup> rawGroups =
   ...
   public SecurityGroup getSecurityGroupById(String id) {
      ...
      org.jclouds.aliyun.domain.SecurityGroup rawGroup
   ...
   public boolean removeSecurityGroup(String id) {
      ...
      org.jclouds.aliyun.domain.SecurityGroup group =
              api.getSecurityGroupApi().getSecurityGroup(id);
   ...
   public SecurityGroup removeIpPermission(IpPermission ipPermission, SecurityGroup group) {
      ...
      org.jclouds.aliyun.domain.SecurityGroup rawGroup = api.getSecurityGroupApi()
              .getSecurityGroup(id);
