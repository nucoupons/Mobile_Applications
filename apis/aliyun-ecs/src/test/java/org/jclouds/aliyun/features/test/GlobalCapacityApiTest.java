...
public class GlobalCapacityApiTest extends BaseAliyunApiTest<GlobalCapacityApi> {
   ...
   public void testListCapacity() throws SecurityException, NoSuchMethodException, IOException {
      ...
      assertRequestLineEquals(httpRequest,
            "GET https://ecs.aliyuncs.com/?response=json&command=listCapacity&listAll=true HTTP/1.1");
   ...
   public void testListCapacityOptions() throws SecurityException, NoSuchMethodException, IOException {
      ...
      assertRequestLineEquals(httpRequest,
            "GET https://ecs.aliyuncs.com/?response=json&command=listCapacity&listAll=true&hostid=3&keyword=fred&podid=4&type=1&zoneid=6 HTTP/1.1");
      assertNonPayloadHeadersEqual(httpRequest, "Accept: application/json\n");
      assertPayloadEquals(httpRequest, null, null, false);
