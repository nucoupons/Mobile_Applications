...
public class AccountApiTest extends BaseAliyunApiTest<AccountApi> {
   ...
   public void testListAccounts() throws SecurityException, NoSuchMethodException, IOException {
      ...
      assertRequestLineEquals(httpRequest,
            "GET https://ecs.aliyuncs.com/?response=json&command=listAccounts&listAll=true HTTP/1.1");
   ...
   public void testListAccountsOptions() throws SecurityException, NoSuchMethodException, IOException {
      ...
      assertRequestLineEquals(httpRequest,
            "GET https://ecs.aliyuncs.com/?response=json&command=listAccounts&listAll=true&account=jclouds&domainid=123 HTTP/1.1");
      assertNonPayloadHeadersEqual(httpRequest, "Accept: application/json\n");
      assertPayloadEquals(httpRequest, null, null, false);
   ...
   public void testGetAccount() throws SecurityException, NoSuchMethodException, IOException {
      ...
      assertRequestLineEquals(httpRequest,
            "GET https://ecs.aliyuncs.com/?response=json&command=listAccounts&listAll=true&id=3 HTTP/1.1");
      assertNonPayloadHeadersEqual(httpRequest, "Accept: application/json\n");
      assertPayloadEquals(httpRequest, null, null, false);
