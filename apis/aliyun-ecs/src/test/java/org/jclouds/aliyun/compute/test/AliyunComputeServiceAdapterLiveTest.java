 ...
 */
package org.jclouds.aliyun.compute.test;
...
public class AliyunComputeServiceAdapterLiveTest extends BaseAliyunApiLiveTest {
   ...
   public void testListImages() {
      Iterable<org.jclouds.aliyun.domain.Template> templates = adapter.listImages();
      assertFalse(Iterables.isEmpty(templates));

      for (org.jclouds.aliyun.domain.Template template : templates) {
