...
import static org.jclouds.aliyun.options.ListDomainChildrenOptions.Builder.parentDomainId;
...
/**
 * Test the Aliyun DomainDomainApi
 */
...
public class DomainDomainApiExpectTest extends BaseAliyunExpectTest<DomainDomainApi> {
   ...
   @Override
   protected DomainDomainApi clientFrom(AliyunContext context) {
